...
const MORI_LIBRARY_BOOKS = {
    ...
    // Список книг (будет заполняться через админку)
    books: [],
        ...
        return [
            {
                ...
                cover: '📜',
                pages: 120,
                description: 'Классика финансовой литературы о принципах накопления богатства.',
                unlocked: true,
                taskId: null,
                file: null
            },
            {
                ...
                cover: '💰',
                pages: 336,
                description: 'Что богатые учат своих детей о деньгах.',
                unlocked: true,
                taskId: null,
                file: null
            },
            {
                ...
                cover: '📊',
                pages: 208,
                description: 'Руководство по достижению финансовой свободы.',
                unlocked: false,
                taskId: 'unlock_book_3',
                file: null
            },
            {
                id: 'book_4',
                ...
                cover: '🧠',
                pages: 256,
                description: 'Классическое пособие по логике.',
                unlocked: true,
                taskId: null,
                file: null
            },
            {
                ...
                cover: '❄️',
                pages: 224,
                description: 'Метод Вима Хофа для контроля тела и разума.',
                unlocked: true,
                taskId: null,
                file: null
            },
            {
                ...
                cover: '🌸',
                pages: 528,
                description: 'Сакральная геометрия и духовные практики.',
                unlocked: false,
                taskId: 'unlock_book_6',
                file: null
            },
            {
                id: 'book_7',
                ...
                cover: '🍵',
                pages: 176,
                description: 'Древний китайский трактат о чае.',
                unlocked: true,
                taskId: null,
                file: null
            },
    ...
    addBook: function(bookData, fileContent) {
        ...
        // Сохраняем содержимое книги отдельно
        if (fileContent) {
    ...
    splitIntoPages: function(text) {
        const pages = [];
        const pageSize = 2000; // символов на страницу
        
        let start = 0;
        while (start < text.length) {
            let end = start + pageSize;
            if (end < text.length) {
                // Ищем конец предложения (., !, ?, и т.д.)
