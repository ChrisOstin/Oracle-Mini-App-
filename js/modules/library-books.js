...
const MORI_LIBRARY_BOOKS = {
    ...
    getDefaultBooks: function() {
        return [
            ...
            { id: 'book_10', title: 'Жизнь и приключения Льюиса Левингстона', author: 'Генри Стэнли', category: 'biography', cover: '🌍', pages: 384, description: 'История исследователя Африки.', unlocked: true, taskId: null, file: null }
        ];
    },
